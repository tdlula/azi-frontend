...
async function testFrontendBackendIntegration() {
  ...
  const tests = [
    ...
    {
      name: 'Dashboard Data',
  url: `${import.meta.env.VITE_PROD_API_BASE_URL || import.meta.env.VITE_DEV_API_BASE_URL || 'http://localhost:5000'}/api/dashboard-data`,
  ...
  url: `${import.meta.env.VITE_PROD_API_BASE_URL || import.meta.env.VITE_DEV_API_BASE_URL || 'http://localhost:5000'}/api/dashboard-data?force_refresh=true`,
      expectedFields: ['metrics', 'charts']
    }
  ];
